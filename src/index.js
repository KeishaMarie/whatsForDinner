...
function printElements(apiResponse) { 
  ...
  let joinIngredients = tryArray.concat(",");
  
  // let ingredientMeasures = [];

  // let l = Math.min(measurementArray.length, ingredientArray.length);

  // for(let i = 0; i< l; i++){

  //   ingredientMeasures.push(measurementArray[i] + " - " + ingredientArray[i],'\n');
  // }
